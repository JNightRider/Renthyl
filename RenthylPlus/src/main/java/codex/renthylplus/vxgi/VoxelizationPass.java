...
public class VoxelizationPass extends RenderTask implements GeometryRenderHandler {
    ...
    public VoxelizationPass(AssetManager assetManager, ResourceAllocator allocator) {
        ...
        clear = UniversalShaderLoader.loadComputeShader(assetManager, "RenthylPlus/MatDefs/VXGI/voxelAssign.glsl", Glsl.V430);
        clear.uniformImage("VoxelMap");
        clear.uniformVector4("Value").set(Vector3f.ZERO);
        mipmapper = UniversalShaderLoader.loadComputeShader(assetManager, "RenthylPlus/MatDefs/VXGI/voxelMipmap.glsl", Glsl.V430);
        mipmapper.uniformTexture("VoxelMap");
        mipmapper.uniformImage("TargetLevel");
        mipmapper.uniformInt("SourceLevel");
        material = new Material(assetManager, "RenthylPlus/MatDefs/VXGI/voxelize.j3md");
