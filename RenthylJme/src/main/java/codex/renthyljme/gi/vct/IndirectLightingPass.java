 ...
 * @author codex
 */
public class IndirectLightingPass extends RasterTask {
    ...
    public IndirectLightingPass(AssetManager assetManager, ResourceAllocator allocator) {
        ...
        shader = UniversalShaderLoader.loadComputeShader(assetManager, "RenthylJme/MatDefs/VXGI/pbrIndirect.glsl");
