 ...
 * @author codex
 */
public class DirectLightingPass extends RasterTask implements GeometryRenderHandler {
    ...
    static {
        adapter.add("Common/MatDefs/Light/PBRLighting.j3md", "RenthylJme/MatDefs/VXGI/pbrDirect.j3md");
    }
