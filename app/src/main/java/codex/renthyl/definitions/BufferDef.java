 ...
 * @param <T>
 */
public class BufferDef <T extends Buffer> extends AbstractResourceDef<T> {

    public static final Function<Integer, ByteBuffer> BYTE = n -> BufferUtils.createByteBuffer(n);
    public static final Function<Integer, IntBuffer> INT = n -> BufferUtils.createIntBuffer(n);
    public static final Function<Integer, FloatBuffer> FLOAT = n -> BufferUtils.createFloatBuffer(n);
    public static final Function<Integer, DoubleBuffer> DOUBLE = n -> BufferUtils.createDoubleBuffer(n);
    public static final Function<Integer, LongBuffer> LONG = n -> BufferUtils.createLongBuffer(n);
    public static final Function<Integer, ShortBuffer> SHORT = n -> BufferUtils.createShortBuffer(n);
    ...
    /**
     * Sets the minimum required size of buffers.
     * 
     * @param size 
     */
